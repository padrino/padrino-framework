    ...
    module Mailer
        ...
        module Helpers
            ...
            module ClassMethods
                ...
                #
                def deliver(mailer_name, message_name, *attributes)
                    (mailer = registered_mailers[mailer_name]) || raise("mailer '#{mailer_name}' is not registered")
                    (message = mailer.messages[message_name]) || raise("mailer '#{mailer_name}' has no message '#{message_name}'")
