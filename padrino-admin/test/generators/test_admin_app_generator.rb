...
describe "AdminAppGenerator" do
  ...
  context 'the admin app generator' do
    ...
    should 'correctly generate a new padrino admin application with default renderer' do
      ...
      assert_match_in_file "button_to('Logout', url(:sessions, :destroy), :method => :delete) { link_to tag_icon(:off, 'Logout'),'#', :id => 'user-logout', :class => 'to_submit' }", "#{@apptmp}/sample_project/admin/views/layouts/application.haml"
    end
    ...
    should 'correctly generate a new padrino admin application with erb renderer' do
      ...
      assert_match_in_file 'class Admin < Padrino::Application', "#{@apptmp}/sample_project/admin/app.rb"
      assert_match_in_file 'role.project_module :accounts, \'/accounts\'', "#{@apptmp}/sample_project/admin/app.rb"
      assert_match_in_file "button_to('Logout', url(:sessions, :destroy), :method => :delete) { link_to tag_icon(:off, 'Logout'),'#', :id => 'user-logout', :class => 'to_submit' }", "#{@apptmp}/sample_project/admin/views/layouts/application.erb"
    end
    ...
    should 'correctly generate a new padrino admin application with slim renderer' do
      ...
      assert_match_in_file 'class Admin < Padrino::Application', "#{@apptmp}/sample_project/admin/app.rb"
      assert_match_in_file 'role.project_module :accounts, \'/accounts\'', "#{@apptmp}/sample_project/admin/app.rb"
      assert_match_in_file "button_to('Logout', url(:sessions, :destroy), :method => :delete) { link_to tag_icon(:off, 'Logout'),'#', :id => 'user-logout', :class => 'to_submit' }", "#{@apptmp}/sample_project/admin/views/layouts/application.slim"
    end
