...
module Padrino
    ...
    module Rendering
        ...
        #
        CONTENT_TYPE_ALIASES = { htm: :html }.freeze

        ##
        # Default options used in the resolve_template-method.
        #
        DEFAULT_RENDERING_OPTIONS = { strict_format: false, raise_exceptions: true }.freeze unless defined?(DEFAULT_RENDERING_OPTIONS)
