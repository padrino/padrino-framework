...
describe "FormBuilder" do
  ...
  module Padrino::Helpers::FormBuilder
    class FakeFormBuilder < AbstractFormBuilder
      def foo_field; @template.content(:span, "bar"); end
    end
  end
  ...
  context 'for #form_for method' do
    should "display correct form html" do
      ...
      assert_has('form', :"accept-charset" => "UTF-8", :action => '/register', :id => 'register', :method => 'post', :content => "Demo") { actual_html }
      assert_has('form input[type=hidden]', :name => '_method', :count => 0) { actual_html } # no method action field
    end
    ...
    should "display correct form html with fake object" do
      ...
      assert_has('form', :"accept-charset" => "UTF-8", :action => '/register', :id => 'register', :method => 'post') { actual_html }
      assert_has('form input', :type => 'text', :name => 'markup_user[username]') { actual_html }
      assert_has('form input[type=hidden]', :name => '_method', :count => 0) { actual_html } # no method action field
    end
    ...
    should "display correct form html for namespaced object" do
      ...
      assert_has('form', :"accept-charset" => "UTF-8", :action => '/register', :method => 'post') { actual_html }
      assert_has('form input', :type => 'text', :name => 'outer_user_account[username]') { actual_html }
    end
    ...
    should "display form specifying default builder setting" do
      ...
      assert_has('form', :"accept-charset" => "UTF-8", :action => '/register', :method => 'post') { actual_html }
      assert_has('span', :content => "bar") { actual_html }
    end
    ...
    should "display correct form html with remote option" do
      ...
      assert_has('form', :"accept-charset" => "UTF-8", :action => '/update', :method => 'post', "data-remote" => 'true') { actual_html }
    end
    ...
    should "display correct form html with remote option and method put" do
      ...
      assert_has('form', :"accept-charset" => "UTF-8", :method => 'post', "data-remote" => 'true') { actual_html }
      assert_has('form input', :type => 'hidden', :name => "_method", :value => 'put') { actual_html }
    end

    should "display correct form html with method :put" do
      actual_html = form_for(@user, '/update', :"accept-charset" => "UTF-8", :method => 'put') { "Demo" }
      assert_has('form', :"accept-charset" => "UTF-8", :action => '/update', :method => 'post') { actual_html }
      assert_has('form input', :type => 'hidden', :name => "_method", :value => 'put') { actual_html }
    end
    ...
    should "display correct form html with method :delete" do
      ...
      assert_has('form', :"accept-charset" => "UTF-8", :action => '/destroy', :method => 'post') { actual_html }
      assert_has('form input', :type => 'hidden', :name => "_method", :value => 'delete') { actual_html }
    end
    ...
    should "display correct form html with multipart" do
      ...
      assert_has('form', :"accept-charset" => "UTF-8", :action => '/register', :enctype => "multipart/form-data") { actual_html }
    end
    ...
    should "support using default standard builder" do
      ...
      assert_has('form p input[type=text]') { actual_html }
    end
    ...
    should "have a class of 'invalid' for fields with errors" do
      ...
      assert_has(:input, :type => 'text', :name => 'user[email]', :id => 'user_email', :class => 'invalid') {actual_html }
    end
    ...
    should "not have a class of 'invalid' for fields with no errors" do
      ...
      assert_has_no(:input, :type => 'text', :name => 'user[first_name]', :id => 'user_first_name', :class => 'invalid') {actual_html }
    end
  end
  ...
  context 'for #fields_for method' do
    should 'display correct fields html' do
      ...
      assert_has(:input, :type => 'text', :name => 'user[first_name]', :id => 'user_first_name') { actual_html }
    end

    should 'display correct fields html with symbol object' do
      actual_html = fields_for(:markup_user) { |f| f.text_field(:first_name) }
      assert_has(:input, :type => 'text', :name => 'markup_user[first_name]', :id => 'markup_user_first_name') { actual_html }
    end
  ...
  context 'for #error_messages method' do
    ...
    should "display correct form html with valid record" do
      ...
      assert_has('#field-errors h2', :content => "Demo form cannot be saved") { actual_html }
      assert_has('#field-errors ul li', :content => "B must be valid") { actual_html }
      assert_has('#field-errors ul li', :content => "A must be present") { actual_html }
      assert_has('#field-errors', :style => "foo:bar") { actual_html }
      assert_has('#field-errors', :class => "mine") { actual_html }
    end
  ...
  context 'for #error_message_on method' do
    ...
    should "display error for specified invalid object" do
      ...
      assert_has('span.error', :content => "foo must be present bar") { actual_html }
    end
    ...
    should "display error for specified invalid object not matching class name" do
      ...
      assert_has('span.error', :content => "foo must be bob bar") { actual_html }
    end
  end
  ...
  context 'for #label method' do
    should "display correct label html" do
      ...
      assert_has('label', :class => 'large', :for => 'user_first_name', :content => "F. Name: ") { actual_html }
    end
  ...
  context 'for #hidden_field method' do
    should "display correct hidden field html" do
      ...
      assert_has('input.hidden[type=hidden]', :value => "54", :id => 'user_session_id', :name => 'user[session_id]') { actual_html }
    end
  ...
  context 'for #text_field method' do
    should "display correct text field html" do
      ...
      assert_has('input.large[type=text]', :value => "Joe", :id => 'user_first_name', :name => 'user[first_name]') { actual_html }
    end
  ...
  context 'for #number_field method' do
    should "display correct number field html" do
      ...
      assert_has('input.numeric[type=number]', :id => 'user_age', :name => 'user[age]') { actual_html }
    end
  ...
  context 'for #telephone_field method' do
    should "display correct telephone field html" do
      ...
      assert_has('input.numeric[type=tel]', :id => 'user_telephone', :name => 'user[telephone]') { actual_html }
    end
  ...
  context 'for #search_field method' do
    should "display correct search field html" do
      ...
      assert_has('input.string[type=search]', :id => 'user_search', :name => 'user[search]') { actual_html }
    end
  ...
  context 'for #email_field method' do
    should "display correct email field html" do
      ...
      assert_has('input.string[type=email]', :id => 'user_email', :name => 'user[email]') { actual_html }
    end
  ...
  context 'for #url_field method' do
    should "display correct url field html" do
      ...
      assert_has('input.string[type=url]', :id => 'user_webpage', :name => 'user[webpage]') { actual_html }
    end
  ...
  context 'for #check_box method' do
    should "display correct checkbox html" do
      ...
      assert_has('input.large[type=checkbox]', :id => 'user_confirm_destroy', :name => 'user[confirm_destroy]') { actual_html }
      assert_has('input[type=hidden]', :name => 'user[confirm_destroy]', :value => '0') { actual_html }
    end

    should "display correct checkbox html when checked" do
      actual_html = standard_builder.check_box(:confirm_destroy, :checked => true)
      assert_has('input[type=checkbox]', :checked => 'checked', :name => 'user[confirm_destroy]') { actual_html }
    end
    ...
    should "display correct checkbox html as checked when object value matches" do
      ...
      assert_has('input[type=checkbox]', :checked => 'checked', :name => 'user[show_favorites]') { actual_html }
    end
    ...
    should "display correct checkbox html as unchecked when object value doesn't match" do
      ...
      actual_html = standard_builder.check_box(:show_favorites, :value => 'human')
      assert_has_no('input[type=checkbox]', :checked => 'checked') { actual_html }
    end
    ...
    should "display correct unchecked hidden field when specified" do
      ...
      assert_has('input[type=hidden]', :name => 'user[show_favorites]', :value => 'false') { actual_html }
    end
  ...
  context 'for #radio_button method' do
    should "display correct radio button html" do
      ...
      assert_has('input.large[type=radio]', :id => 'user_gender_male', :name => 'user[gender]', :value => 'male') { actual_html }
    end

    should "display correct radio button html when checked" do
      actual_html = standard_builder.radio_button(:gender, :checked => true)
      assert_has('input[type=radio]', :checked => 'checked', :name => 'user[gender]') { actual_html }
    end
    ...
    should "display correct radio button html as unchecked when object value doesn't match" do
      ...
      assert_has_no('input[type=radio]', :checked => 'checked') { actual_html }
    end
  ...
  context 'for #text_area method' do
    should "display correct text_area html" do
      ...
      assert_has('textarea.large', :id => 'user_about', :name => 'user[about]') { actual_html }
    end
    ...
    should "display correct text_area html and content" do
      ...
      assert_has('textarea', :id => 'user_about', :content => 'Demo', :rows => '5', :cols => '6') { actual_html }
    end
  ...
  context 'for #password_field method' do
    should "display correct password_field html" do
      ...
      assert_has('input.large[type=password]', :id => 'user_code', :name => 'user[code]') { actual_html }
    end
  ...
  context 'for #file_field method' do
    should "display correct file_field html" do
      ...
      assert_has('input.large[type=file]', :id => 'user_photo', :name => 'user[photo]') { actual_html }
    end
  ...
  context 'for #select method' do
    should "display correct select html" do
      ...
      assert_has('select.selecty', :id => 'user_state', :name => 'user[state]') { actual_html }
      assert_has('select.selecty option', :count => 3) { actual_html }
      assert_has('select.selecty option', :value => 'California', :content => 'California') { actual_html }
      assert_has('select.selecty option', :value => 'Texas',      :content => 'Texas')      { actual_html }
      assert_has('select.selecty option', :value => 'Wyoming',    :content => 'Wyoming')    { actual_html }
    end
    ...
    should "display correct select html with selected item if it matches value" do
      ...
      assert_has('select', :id => 'user_state', :name => 'user[state]') { actual_html }
      assert_has('select option', :selected => 'selected', :count => 1) { actual_html }
      assert_has('select option', :value => 'California', :selected => 'selected') { actual_html }
    end
    ...
    should "display correct select html with selected item if it matches full value" do
      ...
      assert_has('select', :id => 'user_state', :name => 'user[state]') { actual_html }
      assert_has('select option', :selected => 'selected', :count => 1) { actual_html }
      assert_has('select option', :value => 'Cali', :selected => 'selected') { actual_html }
      assert_has('select option', :value => 'California') { actual_html }
    end
    ...
    should "display correct select html with multiple selected items" do
      ...
      assert_has('option', :value => 'foo', :content => 'Foo', :selected => 'selected')  { actual_html }
      assert_has('option', :value => 'bar', :content => 'Bar', :selected => 'selected')  { actual_html }
      assert_has('option', :value => 'baz', :content => 'Baz')  { actual_html }
      assert_has('option', :value => 'bar buz', :content => 'Bar Buz')  { actual_html }
    end
    ...
    should "display correct select html with include_blank" do
      ...
      assert_has('select', :id => 'user_state', :name => 'user[state]') { actual_html }
      assert_has('select option', :count => 4) { actual_html }
      assert_has('select option:first-child', :content => '') { actual_html }
      assert_has('select option:first-child', :value => '') { actual_html }
      actual_html = standard_builder.select(:state, :options => ['California', 'Texas', 'Wyoming'], :include_blank => 'Select')
      assert_has('select', :id => 'user_state', :name => 'user[state]') { actual_html }
      assert_has('select option', :count => 4) { actual_html }
      assert_has('select option:first-child', :content => 'Select') { actual_html }
      assert_has('select option:first-child', :value => '') { actual_html }
    end
    ...
    should "display correct select html with collection passed in" do
      ...
      assert_has('select', :id => 'user_role', :name => 'user[role]') { actual_html }
      assert_has('select option', :count => 3) { actual_html }
      assert_has('select option', :value => '1', :content => 'Admin', :selected => 'selected')     { actual_html }
      assert_has('select option', :value => '2', :content => 'Moderate')  { actual_html }
      assert_has('select option', :value => '3', :content => 'Limited')   { actual_html }
    end
  ...
  context 'for #submit method' do
    should "display correct submit button html with no options" do
      ...
      assert_has('input[type=submit]', :value => "Submit") { actual_html }
    end

    should "display correct submit button html" do
      actual_html = standard_builder.submit("Commit", :class => 'large')
      assert_has('input.large[type=submit]', :value => "Commit") { actual_html }
    end
  ...
  context 'for #image_submit method' do
    ...
    should "display correct image submit button html with no options" do
      ...
      assert_has('input[type=image]', :src => "/images/buttons/ok.png?#{@stamp}") { actual_html }
    end

    should "display correct image submit button html" do
      actual_html = standard_builder.image_submit('/system/ok.png', :class => 'large')
      assert_has('input.large[type=image]', :src => "/system/ok.png") { actual_html }
    end
  ...
  context 'for #fields_for method' do
    ...
    should "display nested children fields one-to-one within form" do
      ...
      assert_has('label', :for => 'user_telephone_attributes_number') { actual_html }
      assert_has('input', :type => 'text', :id => 'user_telephone_attributes_number', :name => 'user[telephone_attributes][number]', :value => "4568769876") { actual_html }
      assert_has('input', :type => 'hidden', :name => 'user[telephone_attributes][_destroy]', :value => '0') { actual_html }
      assert_has('input', :type => 'checkbox', :id => 'user_telephone_attributes__destroy', :name => 'user[telephone_attributes][_destroy]', :value => '1') { actual_html }
    end
    ...
    should "display nested children fields one-to-many within form" do
      ...
      # Address 1 (Saved)
      assert_has('input', :type => 'hidden', :id => 'user_addresses_attributes_0_id', :name => "user[addresses_attributes][0][id]", :value => '20') { actual_html }
      assert_has('label', :for => 'user_addresses_attributes_0_name', :content => 'Name') { actual_html }
      assert_has('input', :type => 'text', :id => 'user_addresses_attributes_0_name', :name => 'user[addresses_attributes][0][name]') { actual_html }
      assert_has('input', :type => 'checkbox', :id => 'user_addresses_attributes_0__destroy', :name => 'user[addresses_attributes][0][_destroy]') { actual_html }
      # Address 2 (New)
      assert_has_no('input', :type => 'hidden', :id => 'user_addresses_attributes_1_id') { actual_html }
      assert_has('label', :for => 'user_addresses_attributes_1_name', :content => 'Name') { actual_html }
      assert_has('input', :type => 'text', :id => 'user_addresses_attributes_1_name', :name => 'user[addresses_attributes][1][name]') { actual_html }
      assert_has_no('input', :type => 'checkbox', :id => 'user_addresses_attributes_1__destroy') { actual_html }
    end
    ...
    should "display fields for explicit instance object" do
      ...
      assert_has('input', :type => 'hidden', :id => 'user_addresses_attributes_0_id', :name => "user[addresses_attributes][0][id]", :value => '40') { actual_html }
      assert_has('label', :for => 'user_addresses_attributes_0_name', :content => 'Name') { actual_html }
      assert_has('input', :type => 'text', :id => 'user_addresses_attributes_0_name', :name => 'user[addresses_attributes][0][name]', :value => "Page") { actual_html }
      assert_has('input', :type => 'checkbox', :id => 'user_addresses_attributes_0__destroy', :name => 'user[addresses_attributes][0][_destroy]', :value => '1') { actual_html }
    end
    ...
    should "display fields for collection object" do
      ...
      assert_has('input', :type => 'hidden', :id => 'user_addresses_attributes_0_id', :name => "user[addresses_attributes][0][id]", :value => '20') { actual_html }
      assert_has('label', :for => 'user_addresses_attributes_0_name', :content => 'Name') { actual_html }
      assert_has('input', :type => 'text', :id => 'user_addresses_attributes_0_name', :name => 'user[addresses_attributes][0][name]', :value => "Foo") { actual_html }
      assert_has('input', :type => 'checkbox', :id => 'user_addresses_attributes_0__destroy', :name => 'user[addresses_attributes][0][_destroy]') { actual_html }
      # Address 3
      assert_has('input', :type => 'hidden', :id => 'user_addresses_attributes_2_id', :value => '50') { actual_html }
      assert_has('label', :for => 'user_addresses_attributes_2_name', :content => 'Name') { actual_html }
      assert_has('input', :type => 'text', :id => 'user_addresses_attributes_2_name', :name => 'user[addresses_attributes][2][name]', :value => "Walter") { actual_html }
      assert_has('input', :type => 'checkbox', :id => 'user_addresses_attributes_2__destroy') { actual_html }
    end
    ...
    should "display fields for arbitrarily deep nested forms" do
      ...
      assert_has('label', :for => 'user_addresses_attributes_1_businesses_attributes_0_name', :content => 'Name') { actual_html }
      assert_has('input', :type => 'text', :id => 'user_addresses_attributes_1_businesses_attributes_0_name', :name => 'user[addresses_attributes][1][businesses_attributes][0][name]') { actual_html }
    end
  ...
  context 'for #text_field_block method' do
    should "display correct text field block html" do
      ...
      assert_has('p label', :for => 'user_first_name', :content => "FName") { actual_html }
      assert_has('p input.large[type=text]', :value => "Joe", :id => 'user_first_name', :name => 'user[first_name]') { actual_html }
    end
  ...
  context 'for #text_area_block method' do
    should "display correct text area block html" do
      ...
      assert_has('p label', :for => 'user_about', :content => "About Me") { actual_html }
      assert_has('p textarea', :id => 'user_about', :name => 'user[about]') { actual_html }
    end
  ...
  context 'for #password_field_block method' do
    should "display correct password field block html" do
      ...
      assert_has('p label', :for => 'user_keycode', :content => "Code: ") { actual_html }
      assert_has('p input.large[type=password]', :id => 'user_keycode', :name => 'user[keycode]') { actual_html }
    end
  ...
  context 'for #file_field_block method' do
    should "display correct file field block html" do
      ...
      assert_has('p label', :for => 'user_photo', :content => "Photo: ") { actual_html }
      assert_has('p input.large[type=file]', :id => 'user_photo', :name => 'user[photo]') { actual_html }
    end
  ...
  context 'for #check_box_block method' do
    should "display correct check box block html" do
      ...
      assert_has('p label', :for => 'user_remember_me', :content => "Remember session?") { actual_html }
      assert_has('p input.large[type=checkbox]', :id => 'user_remember_me', :name => 'user[remember_me]') { actual_html }
    end
  ...
  context 'for #select_block method' do
    should "display correct select_block block html" do
      ...
      assert_has('p label', :for => 'user_country', :content => "Your country") { actual_html }
      assert_has('p select', :id => 'user_country', :name => 'user[country]') { actual_html }
      assert_has('p select option', :content => 'USA')   { actual_html }
      assert_has('p select option', :content => 'Canada') { actual_html }
    end
  ...
  context 'for #submit_block method' do
    should "display correct submit block html" do
      ...
      assert_has('p input.large[type=submit]', :value => 'Update') { actual_html }
    end
  ...
  context 'for #image_submit_block method' do
    ...
    should "display correct image submit block html" do
      ...
      assert_has('p input.large[type=image]', :src => "/images/buttons/ok.png?#{@stamp}") { actual_html }
    end
