...
describe "FormHelpers" do
  ...
  context 'for #form method' do
    should "display correct forms in ruby" do
      actual_html = form('/register', :"accept-charset" => "UTF-8", :class => 'test', :method => "post") { "Demo" }
      assert_has(:form, :"accept-charset" => "UTF-8", :class => "test") { actual_html }
      assert_has('form input', :type => 'hidden', :name => '_method', :count => 0) { actual_html }
    end

    should "display correct text inputs within form" do
      actual_html = form('/register', :"accept-charset" => "UTF-8", :class => 'test') { text_field(:username) }
      assert_has('form input', :type => 'text', :name => "username") { actual_html }
    end

    should "display correct form with remote" do
      actual_html = form('/update', :"accept-charset" => "UTF-8", :class => 'put-form', :remote => true) { "Demo" }
      assert_has(:form, :class => "put-form", :"accept-charset" => "UTF-8", :"data-remote" => 'true') { actual_html }
      assert_has_no(:form, "data-method" => 'post') { actual_html }
    end

    should "display correct form with remote and method is put" do
      actual_html = form('/update', :"accept-charset" => "UTF-8", :method => 'put', :remote => true) { "Demo" }
      assert_has(:form, "data-remote" => 'true', :"accept-charset" => "UTF-8") { actual_html }
      assert_has('form input', :type => 'hidden', :name => "_method", :value => 'put') { actual_html }
    end

    should "display correct form with method :put" do
      actual_html = form('/update', :"accept-charset" => "UTF-8", :class => 'put-form', :method => "put") { "Demo" }
      assert_has(:form, :class => "put-form", :"accept-charset" => "UTF-8", :method => 'post') { actual_html }
      assert_has('form input', :type => 'hidden', :name => "_method", :value => 'put') { actual_html }
    end

    should "display correct form with method :delete and charset" do
      actual_html = form('/remove', :"accept-charset" => "UTF-8", :class => 'delete-form', :method => "delete") { "Demo" }
      assert_has(:form, :class => "delete-form", :"accept-charset" => "UTF-8", :method => 'post') { actual_html }
      assert_has('form input', :type => 'hidden', :name => "_method", :value => 'delete') { actual_html }
    end

    should "display correct form with charset" do
      actual_html = form('/charset', :"accept-charset" => "UTF-8", :class => 'charset-form') { "Demo" }
      assert_has(:form, :class => "charset-form", :"accept-charset" => "UTF-8", :method => 'post') { actual_html }
    end

    should "display correct form with multipart encoding" do
      actual_html = form('/remove', :"accept-charset" => "UTF-8", :multipart => true) { "Demo" }
      assert_has(:form, :enctype => "multipart/form-data") { actual_html }
    end
  ...
  context 'for #field_set method' do
    should "display correct field_sets in ruby" do
      actual_html = field_set("Basic", :class => 'basic') { "Demo" }
      assert_has(:fieldset, :class => 'basic') { actual_html }
      assert_has('fieldset legend', :content => "Basic") { actual_html }
    end
  ...
  context 'for #error_messages_for method' do
    should "display correct error messages list in ruby" do
      ...
      assert_has('div.field-errors') { actual_html }
      assert_has('div.field-errors h2', :content => "2 errors prohibited this User from being saved") { actual_html }
      assert_has('div.field-errors p', :content => "There were problems with the following fields:") { actual_html }
      assert_has('div.field-errors ul') { actual_html }
      assert_has('div.field-errors ul li', :count => 2) { actual_html }
    end
  ...
  context 'for #error_message_on method' do
    should "display correct error message on specified model name in ruby" do
      ...
      assert_has('span.error', :content => "foo 1 bar") { actual_html }
    end
  ...
  context 'for #label method' do
    should "display label tag in ruby" do
      actual_html = label(:username, :class => 'long-label', :caption => "Nickname")
      assert_has(:label, :for => 'username', :class => 'long-label', :content => "Nickname") { actual_html }
    end

    should "display label tag in ruby with required" do
      actual_html = label(:username, :caption => "Nickname", :required => true)
      assert_has(:label, :for => 'username', :content => 'Nickname') { actual_html }
      assert_has('label[for=username] span.required', :content => "*") { actual_html }
    end
  ...
  context 'for #hidden_field method' do
    should "display hidden field in ruby" do
      actual_html = hidden_field(:session_key, :id => 'session_id', :value => '56768')
      assert_has(:input, :type => 'hidden', :id => "session_id", :name => 'session_key', :value => '56768') { actual_html }
    end
  ...
  context 'for #text_field method' do
    should "display text field in ruby" do
      actual_html = text_field(:username, :class => 'long')
      assert_has(:input, :type => 'text', :class => "long", :name => 'username') { actual_html }
    end
  ...
  context 'for #number_field method' do
    should "display number field in ruby" do
      actual_html = number_field(:age, :class => 'numeric')
      assert_has(:input, :type => 'number', :class => 'numeric', :name => 'age') { actual_html }
    end
  ...
  context 'for #telephone_field method' do
    should "display number field in ruby" do
      actual_html = telephone_field(:telephone, :class => 'numeric')
      assert_has(:input, :type => 'tel', :class => 'numeric', :name => 'telephone') { actual_html }
    end
  ...
  context 'for #search_field method' do
    should "display search field in ruby" do
      actual_html = search_field(:search, :class => 'string')
      assert_has(:input, :type => 'search', :class => 'string', :name => 'search') { actual_html }
    end
  ...
  context 'for #email_field method' do
    should "display email field in ruby" do
      actual_html = email_field(:email, :class => 'string')
      assert_has(:input, :type => 'email', :class => 'string', :name => 'email') { actual_html }
    end
  ...
  context 'for #url_field method' do
    should "display url field in ruby" do
      actual_html = url_field(:webpage, :class => 'string')
      assert_has(:input, :type => 'url', :class => 'string', :name => 'webpage') { actual_html }
    end
  ...
  context 'for #text_area method' do
    should "display text area in ruby" do
      actual_html = text_area(:about, :class => 'long')
      assert_has(:textarea, :class => "long", :name => 'about') { actual_html }
    end

    should "display text area in ruby with specified content" do
      actual_html = text_area(:about, :value => "a test", :rows => 5, :cols => 6)
      assert_has(:textarea, :content => "a test", :name => 'about', :rows => "5", :cols => "6") { actual_html }
    end
  ...
  context 'for #password_field method' do
    should "display password field in ruby" do
      actual_html = password_field(:password, :class => 'long')
      assert_has(:input, :type => 'password', :class => "long", :name => 'password') { actual_html }
    end
  ...
  context 'for #file_field method' do
    should "display file field in ruby" do
      actual_html = file_field(:photo, :class => 'photo')
      assert_has(:input, :type => 'file', :class => "photo", :name => 'photo') { actual_html }
    end
  ...
  context "for #check_box method" do
    should "display check_box tag in ruby" do
      actual_html = check_box("clear_session")
      assert_has(:input, :type => 'checkbox', :value => '1', :name => 'clear_session') { actual_html }
      assert_has_no(:input, :type => 'hidden') { actual_html }
    end

    should "display check_box tag in ruby with extended attributes" do
      actual_html = check_box("clear_session", :disabled => true, :checked => true)
      assert_has(:input, :type => 'checkbox', :disabled => 'disabled', :checked => 'checked') { actual_html }
    end
  ...
  context "for #radio_button method" do
    should "display radio_button tag in ruby" do
      actual_html = radio_button("gender", :value => 'male')
      assert_has(:input, :type => 'radio', :value => 'male', :name => 'gender') { actual_html }
    end

    should "display radio_button tag in ruby with extended attributes" do
      actual_html = radio_button("gender", :disabled => true, :checked => true)
      assert_has(:input, :type => 'radio', :disabled => 'disabled', :checked => 'checked') { actual_html }
    end
  ...
  context "for #select method" do
    should "display select tag in ruby" do
      actual_html = select(:favorite_color, :options => ['green', 'blue', 'black'], :include_blank => true)
      assert_has(:select, :name => 'favorite_color') { actual_html }
      assert_has('select option:first-child', :content => '') { actual_html }
      assert_has('select option', :content => 'green', :value => 'green') { actual_html }
      assert_has('select option', :content => 'blue',  :value => 'blue')  { actual_html }
      assert_has('select option', :content => 'black', :value => 'black') { actual_html }
    end

    should "display select tag in ruby with extended attributes" do
      actual_html = select(:favorite_color, :disabled => true, :options => ['only', 'option'])
      assert_has(:select, :disabled => 'disabled') { actual_html }
    end

    should "take a range as a collection for options" do
      actual_html = select(:favorite_color, :options => (1..3))
      assert_has(:select) { actual_html }
      assert_has('select option', :value => '1') { actual_html }
      assert_has('select option', :value => '2') { actual_html }
      assert_has('select option', :value => '3') { actual_html }
    end

    should "include blank for grouped options" do
      opts = { "Red"  => ["Rose","Fire"], "Blue" => ["Sky","Sea"] }
      actual_html = select( 'color', :grouped_options => opts, :include_blank => true )
      assert_has('select option:first-child', :value => "", :content => "") { actual_html }
    end
    ...
    should "return a select tag with grouped options for an nested array" do
      ...
      actual_html = select( 'name', :grouped_options => opts )
      assert_has(:select,   :name => "name") { actual_html }
      assert_has(:optgroup, :label => "Friends") { actual_html }
      assert_has(:option,   :value => "Yoda", :content => "Yoda") { actual_html }
      assert_has(:option,   :value => "2",  :content => "Obiwan") { actual_html }
      assert_has(:optgroup, :label => "Enemies") { actual_html }
      assert_has(:option,   :value => "Palpatine", :content => "Palpatine") { actual_html }
      assert_has(:option,   :value => "3", :content => "Darth Vader") { actual_html }
    end
    ...
    should "display select tag in ruby with multiple attribute" do
      actual_html = select(:favorite_color, :multiple => true, :options => ['only', 'option'])
      assert_has(:select, :multiple => 'multiple', :name => 'favorite_color[]') { actual_html }
    end

    should "display options with values and single selected" do
      options = [['Green', 'green1'], ['Blue', 'blue1'], ['Black', "black1"]]
      actual_html = select(:favorite_color, :options => options, :selected => 'green1')
      assert_has(:select, :name => 'favorite_color') { actual_html }
      assert_has('select option', :selected => 'selected', :count => 1) { actual_html }
      assert_has('select option', :content => 'Green', :value => 'green1', :selected => 'selected') { actual_html }
      assert_has('select option', :content => 'Blue', :value => 'blue1') { actual_html }
      assert_has('select option', :content => 'Black', :value => 'black1') { actual_html }
    end

    should "display option with values and multiple selected" do
      options = [['Green', 'green1'], ['Blue', 'blue1'], ['Black', "black1"]]
      actual_html = select(:favorite_color, :options => options, :selected => ['green1', 'Black'])
      assert_has(:select, :name => 'favorite_color') { actual_html }
      assert_has('select option', :selected => 'selected', :count => 2) { actual_html }
      assert_has('select option', :content => 'Green', :value => 'green1', :selected => 'selected') { actual_html }
      assert_has('select option', :content => 'Blue', :value => 'blue1') { actual_html }
      assert_has('select option', :content => 'Black', :value => 'black1', :selected => 'selected') { actual_html }
    end

    should "display options selected only for exact match" do
      options = [['One', '1'], ['1', '10'], ['Two', "-1"]]
      actual_html = select(:range, :options => options, :selected => '-1')
      assert_has(:select, :name => 'range') { actual_html }
      assert_has('select option', :selected => 'selected', :count => 1) { actual_html }
      assert_has('select option', :content => 'Two', :value => '-1', :selected => 'selected') { actual_html }
    end
  ...
  context 'for #submit method' do
    should "display submit tag in ruby" do
      actual_html = submit("Update", :class => 'success')
      assert_has(:input, :type => 'submit', :class => "success", :value => 'Update') { actual_html }
    end
  ...
  context 'for #button method' do
    should "display submit tag in ruby" do
      actual_html = button("Cancel", :class => 'clear')
      assert_has(:input, :type => 'button', :class => "clear", :value => 'Cancel') { actual_html }
    end
  ...
  context 'for #image_submit method' do
    ...
    should "display image submit tag in ruby with relative path" do
      actual_html = image_submit('buttons/ok.png', :class => 'success')
      assert_has(:input, :type => 'image', :class => "success", :src => "/images/buttons/ok.png?#{@stamp}") { actual_html }
    end

    should "display image submit tag in ruby with absolute path" do
      actual_html = image_submit('/system/ok.png', :class => 'success')
      assert_has(:input, :type => 'image', :class => "success", :src => "/system/ok.png") { actual_html }
    end
