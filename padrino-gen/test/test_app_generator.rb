...
describe "AppGenerator" do
  ...
  context 'the app generator' do
    ...
    should "create correctly a new padrino application" do
      ...
      assert_match_in_file("Padrino.mount('Demo::App', :app_file => File.expand_path('../../demo/app.rb', __FILE__)).to('/demo')", "#{@apptmp}/sample_project/config/apps.rb")
    ...
    should "create correctly a new padrino application with an underscore name" do
      ...
      assert_match_in_file("Padrino.mount('DemoApp::App', :app_file => File.expand_path('../../demo_app/app.rb', __FILE__)).to('/demo_app')", "#{@apptmp}/sample_project/config/apps.rb")
