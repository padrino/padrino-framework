...
:title: Extensions
---
p. Extensions provide helper or class methods for Sinatra and Padrino applications. See "the Sinatra
extensions page":http://www.sinatrarb.com/extensions-wild.html for more information about this topic.

p. We also have some 3rd party extensions (ex: for ActiveRecord/MongoMapper/DataMapper, etc..) that are useful
for web developers.

h2. Usage

p. If the extension is a gem put it in +Gemfile+ otherwise create a file under your +lib+ directory.

h2. Extension List

|_. What             |_. Description                              |_. Where |
