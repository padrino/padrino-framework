...
add_file :filename => 'somefile.png', :content => File.open('/full/path/to/somefile.png', 'rb') { |f| f.read }
...
Remember than you can still access Padrino, therefore you could use helpers like **url** to get a particular's url formatted for you:
