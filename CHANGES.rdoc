...
* NEW #1573 Add report_csrf_failure, enable custom reports
...
* NEW Refactor application code moving setup into an application_setup file (@ujifgc)
...
* FIX #1606 Adjust tests to run on newer minitest versions (@dariocravero)
...
* NEW #1612 Refactor support_lite into a padrino-support gem outside of core (@ujifgc)
...
* NEW #1560 Introduces cache_object helper (@ujifgc)
* FIX #1624 Detect path absoluteness properly
...
* FIX #1634 Improve caching of template paths
