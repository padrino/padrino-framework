...
* FIX #1701 don't load admin locales automatically and remove ActiveRecord's local copy of the
locales (@dariocravero).
IMPORTANT: If you're using the admin locales and you're not using `Padrino::Admin::AccessControl`
