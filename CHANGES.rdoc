...
* FIX cleanup and refactoring of documentation (@matthias-guenther)
* FIX padrino cache tests to not execute when cache server is not available (@bash0C7)
* SEC #1083 Bump mail version dependency to CVE-2012-2139 and CVE-2012-2140. (@nequena)
...
* REM #1063 Remove core JSON rendering in favour of sinatra-contrib (@Ortuna)
