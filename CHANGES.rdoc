...
* FIX #1443 Don't step over :session_id setting on admin apps (@ujifgc)
...
* FIX #1507 patch jruby utf-8 method naming (@namusyaka)
* FIX #1505 Remove charset from json mimetype, fix sinatra edge (@ujifgc)
...
* NEW #1541 Reimplement authenticity token logic (@ujifgc)
