...
* Updated http_router to 0.6.4
* [padrino-cache] Updated Doc [Thanks to Onethirtyfive]
* [padrino-cache] Ability to store/execute code in file store
* [padrino-cache] Added a global Padrino.cache option
* [padrino-cache] Ability to store/execute code in redis store
* [padrino-cache] Fix expire_in on redis store
