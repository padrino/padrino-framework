...
* Updated Padrino Cache Doc [Thanks to Onethirtyfive]
* Ability to store/execute code in file store in Padrino Cache
* Ability to store/execute code in redis store in Padrino Cache
* Added a global Padrino.cache option
* Fix expire_in on redis store in Padrino Cache
* Added Ajax Helpers
* Use https://github.com/padrino/padrino-static for download js and ujs adapters
