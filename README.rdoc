...
* Try the new {FAQ's}[https://github.com/padrino/padrino-framework/blob/master/padrino-docs/pages/faq.md].
...
Copyright (c) 2010-2015 Padrino. See LICENSE for details.
