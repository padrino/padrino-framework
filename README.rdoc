...
If you wnat to build a standalone app you need to take some precautions see example:
...
See: http://github.com/padrino/padrino-framework/blob/master/padrino-admin/lib/padrino-admin/helpers/view.rb#L145
