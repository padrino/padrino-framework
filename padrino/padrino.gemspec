...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<padrino-helpers>, ["= 0.6.2"])
      s.add_runtime_dependency(%q<padrino-mailer>, ["= 0.6.2"])
      s.add_runtime_dependency(%q<padrino-gen>, ["= 0.6.2"])
      s.add_runtime_dependency(%q<padrino-admin>, ["= 0.6.2"])
    else
      ...
      s.add_dependency(%q<padrino-helpers>, ["= 0.6.2"])
      s.add_dependency(%q<padrino-mailer>, ["= 0.6.2"])
      s.add_dependency(%q<padrino-gen>, ["= 0.6.2"])
      s.add_dependency(%q<padrino-admin>, ["= 0.6.2"])
    end
  else
    s.add_dependency(%q<sinatra>, [">= 0.9.2"])
    s.add_dependency(%q<haml>, [">= 2.2.1"])
