...
module Padrino
    ...
    #
    class Mounter
        DEFAULT_CASCADE = [404, 405].freeze
        ...
        #
        def ==(other)
            other.is_a?(Mounter) && app_class == other.app_class && uri_root == other.uri_root
        end
        ...
        def locate_app_file
            ...
            Padrino.modules.each do |mod|
                candidates << mod.root(simple_name, 'app.rb') if mod.name == mod_name
            end
