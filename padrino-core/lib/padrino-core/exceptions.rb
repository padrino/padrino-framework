...
module Padrino
  ...
  # Padrino::Exceptions catches all exceptions raised from the app it
  ...
  class Exceptions < Rack::ShowExceptions
    ...
    def frame_class(frame)
      if frame.filename =~ /lib\/padrino.*\.rb/
        "framework"
    ...
    HTML_TEMPLATE = <<-HTML.undent unless defined?(HTML_TEMPLATE) # :nodoc:
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div id="wrap">
          <div id="header">
            <img src="<%= env['SCRIPT_NAME'] %>/__padrino__/500.png" alt="application error" height="161" width="313" />
            <div id="summary">
